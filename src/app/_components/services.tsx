    ...
    <section className="bg-white py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          <div className="overflow-hidden" ref={emblaRef}>
            <div className="flex">
              {services.map((item, index) => (
                <div
                  key={index}
                  className="flex-[0_0_100%] min-w-0 px-3 md:flex-[0_0_calc(100%/3)] px-3"
                >
                  <article className="bg-[#1e293b] text-white rounded-2xl p-6 space-y-4 h-full flex flex-col">
                    <div className="flex-1 flex items-start justify-between">
                      ...
                      <div className="flex gap-3 ">
                        ...
                        <div>
                          <h3 className="text-2xl font-bold text-xl my-1">
                            {item.title}
                          </h3>
                    ...
                    <div className="border-t border-gray-700 pt-4 flex items-center justify-between">
                      ...
                      <a href="#"
                      className="flex items-center gap-2 hover:bg-red-500 px-4 pt-1 rounded-md duration-300"
                      >
          ...
          <button onClick={scrollPrev} className=" bg-white flex items-center justify-center rounded-full shadow-md w-10 h-10 absolute -left-6 translate-y/1/2 translate-x-1/2 top-1/3 z-10">
            <ChevronLeft 
            className=" w-6 h-6 text-gray-600"
            />
          </button>

          <button onClick={scrollNext} className=" bg-white flex items-center justify-center rounded-full shadow-md w-10 h-10 absolute right-4 translate-y/1/2 translate-x-1/2 top-1/3 z-10">
            <ChevronRight 
            className=" w-6 h-6 text-gray-600"
            />
          </button>
